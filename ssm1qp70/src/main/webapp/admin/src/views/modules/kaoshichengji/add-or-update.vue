<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="正确数" prop="zhengqueshu">
          <el-input v-model="ruleForm.zhengqueshu" 
              placeholder="正确数" clearable  :readonly="ro.zhengqueshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="正确数" prop="zhengqueshu">
              <el-input v-model="ruleForm.zhengqueshu" 
                placeholder="正确数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考试成绩" prop="kaoshichengji">
          <el-input v-model="ruleForm.kaoshichengji" 
              placeholder="考试成绩" clearable  :readonly="ro.kaoshichengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考试成绩" prop="kaoshichengji">
              <el-input v-model="ruleForm.kaoshichengji" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.ceshimingcheng = true;
          ...
          if(o=='zhengqueshu'){
            this.ruleForm.zhengqueshu = obj[o];
	    this.ro.zhengqueshu = true;
            continue;
          }
          if(o=='kaoshichengji'){
            this.ruleForm.kaoshichengji = obj[o];
	    this.ro.kaoshichengji = true;
            continue;
          }
          if(o=='paiming'){
