<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="答题" prop="dati">
          <el-input v-model="ruleForm.dati" 
              placeholder="答题" clearable  :readonly="ro.dati"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="答题" prop="dati">
              <el-input v-model="ruleForm.dati" 
                placeholder="答题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="批改" prop="pigai">
          <el-select v-model="ruleForm.pigai" placeholder="请选择批改">
            <el-option
                v-for="(item,index) in pigaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="批改" prop="pigai">
	      <el-input v-model="ruleForm.pigai"
                placeholder="批改" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="正确答案" prop="zhengquedaan">
          <el-input v-model="ruleForm.zhengquedaan" 
              placeholder="正确答案" clearable  :readonly="ro.zhengquedaan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="正确答案" prop="zhengquedaan">
              <el-input v-model="ruleForm.zhengquedaan" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dati = true;
          ...
          if(o=='pigai'){
            this.ruleForm.pigai = obj[o];
	    this.ro.pigai = true;
            continue;
          }
          if(o=='zhengquedaan'){
            this.ruleForm.zhengquedaan = obj[o];
	    this.ro.zhengquedaan = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shijuanpiyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shijuanpiyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
